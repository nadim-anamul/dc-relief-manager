    ...
    public function run(): void
    {
        ...
        $applications = [
            ...
            [
                ...
                'upazila_id' => $upazilas->where('name', 'Sariakandi')->first()->id ?? $upazilas->first()->id,
                'union_id' => $unions->where('upazila_id', $upazilas->where('name', 'Sariakandi')->first()->id ?? $upazilas->first()->id)->first()->id,
            ...
            [
                ...
                'zilla_id' => $zillas->first()->id,
                'upazila_id' => $upazilas->where('name', 'Shibganj')->first()->id ?? $upazilas->skip(1)->first()->id,
                'union_id' => $unions->where('upazila_id', $upazilas->where('name', 'Shibganj')->first()->id ?? $upazilas->skip(1)->first()->id)->first()->id,
            ...
            [
                ...
                'union_id' => $unions->where('upazila_id', $upazilas->where('name', 'Sariakandi')->first()->id ?? $upazilas->skip(2)->first()->id)->first()->id,
            ...
            [
                ...
                'union_id' => $unions->where('upazila_id', $upazilas->where('name', 'Dhunat')->first()->id ?? $upazilas->skip(3)->first()->id)->first()->id,
            ...
            [
                ...
                'zilla_id' => $zillas->first()->id,
                'upazila_id' => $upazilas->where('name', 'Bogura Sadar')->first()->id ?? $upazilas->skip(4)->first()->id,
                'union_id' => $unions->where('upazila_id', $upazilas->where('name', 'Bogura Sadar')->first()->id ?? $upazilas->skip(4)->first()->id)->first()->id,
            ...
            [
                ...
                'zilla_id' => $zillas->first()->id,
                'upazila_id' => $upazilas->where('name', 'Gabtali')->first()->id ?? $upazilas->skip(5)->first()->id,
                'union_id' => $unions->where('upazila_id', $upazilas->where('name', 'Gabtali')->first()->id ?? $upazilas->skip(5)->first()->id)->first()->id,
            ...
            [
                ...
                'union_id' => $unions->where('upazila_id', $upazilas->where('name', 'Nandigram')->first()->id ?? $upazilas->skip(6)->first()->id)->first()->id,

...
class DetailedUpazilaDistributionExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithColumnWidths
{
	protected $filters;
	...
	public function map($row): array
	{
		...
		return [
			...
			$row->project_name,
			$row->zilla_name,
			$row->upazila_name_bn ?: $row->upazila_name,

<x-main-layout>
				...
				<form action="{{ route('relief-applications.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8" x-data="reliefApplicationForm()">
					...
					<div class="border-b border-gray-200 dark:border-gray-700 pb-8">
						<div class="flex items-center mb-6">
							...
							<div class="ml-3">
								<h4 class="text-lg font-semibold text-gray-900 dark:text-white {{ app()->isLocale('bn') ? 'font-sans' : '' }}">{{ __('Application Type') }}</h4>
								<p class="text-sm text-gray-500 dark:text-gray-400 {{ app()->isLocale('bn') ? 'font-sans' : '' }}">{{ __('Select whether you are applying as an individual or organization') }}</p>
							</div>
						</div>
						...
						<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
							<div class="md:col-span-2">
								...
								<select name="application_type" 
									...
									<option value="organization" {{ old('application_type') == 'organization' ? 'selected' : '' }}>{{ __('Organization') }}</option>
								</select>
					...
					<div class="border-b border-gray-200 dark:border-gray-700 pb-8">
						<div class="flex items-center mb-6">
							...
							<div class="ml-3">
								<h4 class="text-lg font-semibold text-gray-900 dark:text-white {{ app()->isLocale('bn') ? 'font-sans' : '' }}">{{ __('Relief Information') }}</h4>
								<p class="text-sm text-gray-500 dark:text-gray-400 {{ app()->isLocale('bn') ? 'font-sans' : '' }}">{{ __('Details about your relief request') }}</p>
							</div>
						</div>
					...
					<!-- 3. Organization Information Section (only for organizations, shown first) -->
					<div class="border-b border-gray-200 dark:border-gray-700 pb-8" x-show="applicationType === 'organization'">
						<div class="flex items-center mb-6">
							<div class="flex-shrink-0">
						...
						<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
							...
							<div class="md:col-span-2">
								...
								<textarea name="organization_address" 
									...
									x-bind:required="applicationType === 'organization'">{{ old('organization_address') }}</textarea>
					...
					<!-- 4. Applicant Information Section -->
					<div class="border-b border-gray-200 dark:border-gray-700 pb-8">
						<div class="flex items-center mb-6">
							<div class="flex-shrink-0">
							...
							<div class="ml-3">
								<h4 class="text-lg font-semibold text-gray-900 dark:text-white {{ app()->isLocale('bn') ? 'font-sans' : '' }}">{{ __('Applicant Information') }}</h4>
								<p class="text-sm text-gray-500 dark:text-gray-400 {{ app()->isLocale('bn') ? 'font-sans' : '' }}">{{ __('Contact person details') }}</p>
							</div>
						</div>
						...
						<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
							...
							<div x-show="applicationType === 'organization'">
					...
					<div class="border-b border-gray-200 dark:border-gray-700 pb-8">
						<div class="flex items-center mb-6">
							...
							<div class="ml-3">
								<h4 class="text-lg font-semibold text-gray-900 dark:text-white {{ app()->isLocale('bn') ? 'font-sans' : '' }}">{{ __('Location Information') }}</h4>
								<p class="text-sm text-gray-500 dark:text-gray-400 {{ app()->isLocale('bn') ? 'font-sans' : '' }}">{{ __('Specify your geographic location') }}</p>
							</div>
						</div>
					...
					<div class="pb-8">
						<div class="flex items-center mb-6">
							...
							<div class="ml-3">
								<h4 class="text-lg font-semibold text-gray-900 dark:text-white {{ app()->isLocale('bn') ? 'font-sans' : '' }}">{{ __('Supporting Documents') }}</h4>
								<p class="text-sm text-gray-500 dark:text-gray-400 {{ app()->isLocale('bn') ? 'font-sans' : '' }}">{{ __('Attach supporting documents (optional)') }}</p>
							</div>
						</div>
					...
					<div class="bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-700 dark:to-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-600">
						<div class="flex items-center justify-between">
							<div>
								<h5 class="text-lg font-semibold text-gray-900 dark:text-white {{ app()->isLocale('bn') ? 'font-sans' : '' }}">{{ __('Ready to Submit?') }}</h5>
								<p class="text-sm text-gray-600 dark:text-gray-400 {{ app()->isLocale('bn') ? 'font-sans' : '' }}">{{ __('Please review all information before submitting your application.') }}</p>
							</div>
	...
	<script>
		function reliefApplicationForm() {
			return {
				applicationType: '{{ old('application_type') }}',

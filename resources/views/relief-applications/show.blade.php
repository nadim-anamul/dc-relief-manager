				...
				<div class="flex items-center">
					...
					<div class="ml-3">
						<h3 class="text-lg font-medium text-gray-900 dark:text-white">
							{{ $reliefApplication->application_type === 'individual' ? 'Individual Information' : 'Organization Information' }}
						</h3>
					</div>
				</div>
			</div>
			<div class="p-6">
				<dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
					@if($reliefApplication->application_type === 'individual')
						...
						<div>
							<dt class="text-sm font-medium text-gray-500 dark:text-gray-400">NID</dt>
					...
					@else
						...
						<div class="sm:col-span-2">
							<dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Contact Person Address</dt>
							<dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ $reliefApplication->applicant_address }}</dd>
						</div>
					@endif
				</dl>

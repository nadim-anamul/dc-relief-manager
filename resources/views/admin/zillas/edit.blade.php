<x-main-layout>
	<x-slot name="header">
		<div class="flex items-center">
			...
			<h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Zilla</h1>
		</div>
	</x-slot>
	...
	<div class="max-w-2xl mx-auto">
		<div class="card">
			<div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
				<h3 class="text-lg font-medium text-gray-900 dark:text-white">Edit Zilla Information</h3>
			</div>
			<div class="p-6">
				<form action="{{ route('admin.zillas.update', $zilla) }}" method="POST" class="space-y-6">
					@csrf
					@method('PUT')
					...
					<div>
						...
						<input type="text" 
							name="name_bn" 
							id="name_bn" 
							value="{{ old('name_bn', $zilla->name_bn) }}"
					...
					<div>
						<label class="flex items-center">
							<input type="checkbox" 
								name="is_active" 
								value="1"
								{{ old('is_active', $zilla->is_active) ? 'checked' : '' }}

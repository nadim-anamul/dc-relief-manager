	...
	<div class="space-y-6">
		...
		<div class="card p-6">
			...
			<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
				...
				<div>
					<label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Model ID</label>
		...
		@if($auditLog->changed_fields)
			<div class="card p-6">
				<h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Changed Fields</h3>
		...
		@if($auditLog->old_values)
			<div class="card p-6">
				<h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Previous Values</h3>
		...
		@if($auditLog->new_values)
			<div class="card p-6">
				<h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">New Values</h3>
				<div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
		...
		@if($auditLog->remarks)
			<div class="card p-6">
				<h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Remarks</h3>
				<div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
		...
		@if($auditLog->auditable)
			<div class="card p-6">
				<h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Related Model Information</h3>
				<div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">

	...
	<div class="max-w-2xl mx-auto">
		<div class="card">
			<div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
				<h3 class="text-lg font-medium text-gray-900 dark:text-white">Relief Type Information</h3>
			</div>
			<div class="p-6">
				<form action="{{ route('admin.relief-types.store') }}" method="POST" class="space-y-6">
					@csrf
					...
					<div>
						...
						<textarea name="description_bn" 
							...
							placeholder="বাংলা বর্ণনা লিখুন">{{ old('description_bn') }}</textarea>

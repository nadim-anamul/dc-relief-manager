<x-main-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Create Relief Item</h1>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="type" 
                            ...
                            <option value="shelter" {{ old('type') === 'shelter' ? 'selected' : '' }}>Shelter</option>
                    ...
                    <div>
                        ...
                        <select id="unit" 
                            ...
                            <option value="BDT" {{ old('unit') === 'BDT' ? 'selected' : '' }}>BDT (৳)</option>
                            <option value="metric_ton" {{ old('unit') === 'metric_ton' ? 'selected' : '' }}>Metric Ton</option>
                    ...
                    <div>
                        ...
                        <textarea id="description" 
                                  ...
                                  placeholder="Brief description of the relief item">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>

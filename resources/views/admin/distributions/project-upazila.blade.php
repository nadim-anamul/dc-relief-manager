<x-main-layout>
    <x-slot name="header">
        <div class="flex flex-col lg:flex-row lg:justify-between lg:items-center space-y-4 lg:space-y-0">
            <div class="flex items-center space-x-3">
                <div class="p-2 bg-gradient-to-r from-green-500 to-teal-600 rounded-xl">
    ...
    <div class="space-y-8">
        <!-- Smart Filter Row -->
        <div>
            <form method="GET" action="{{ route('admin.distributions.project-upazila') }}" class="w-full relative overflow-hidden rounded-2xl shadow-xl">
                <div class="absolute inset-0 bg-gradient-to-r from-green-500/10 via-teal-500/10 to-cyan-500/10 pointer-events-none"></div>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-8">
            <!-- Upazila Relief Distribution Chart -->
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">

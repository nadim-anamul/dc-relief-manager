<x-main-layout>
    ...
    <div class="space-y-8">
        <!-- Smart Filter Row -->
        <div>
            <form method="GET" action="{{ route('admin.distributions.union-summary') }}" class="w-full relative overflow-hidden rounded-2xl shadow-xl">
                <div class="absolute inset-0 bg-gradient-to-r from-purple-500/10 via-pink-500/10 to-rose-500/10 pointer-events-none"></div>
            ...
            <div class="overflow-x-auto">
                <table id="detailedTable" class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="px-6 py-4 text-center text-gray-500 dark:text-gray-400">No detailed data available</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
                ...
                buttons: [
                    {
                        ...
                        messageTop: function() {
                            ...
                            @if($selectedUpazilaId)
                                filters.push('Upazila: {{ $upazilas->firstWhere("id", $selectedUpazilaId)?->name ?? "Unknown" }}');
                            @endif

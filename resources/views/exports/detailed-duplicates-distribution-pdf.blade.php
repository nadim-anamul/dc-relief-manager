...
<head>
    ...
    <title>নকল বরাদ্দ রিপোর্ট</title>
...
<body>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 25%;">সংস্থার নাম</th>
                <th style="width: 15%;">সংস্থার ধরন</th>
                <th style="width: 12%;">জেলা</th>
                <th style="width: 12%;">উপজেলা</th>
                <th style="width: 10%;">প্রকল্প সংখ্যা</th>
                <th style="width: 12%;">মোট পরিমাণ</th>
                <th style="width: 9%;">আবেদন সংখ্যা</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">{{ bn_number($item->project_count) }}</td>
    ...
    @else
    <div class="no-data">
        <h3>কোনো নকল বরাদ্দ পাওয়া যায়নি</h3>
        <p>বর্তমান ফিল্টার অনুযায়ী কোনো নকল বরাদ্দ খুঁজে পাওয়া যায়নি।</p>
    </div>
    @endif

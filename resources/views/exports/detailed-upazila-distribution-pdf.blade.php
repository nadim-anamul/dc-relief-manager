...
<head>
    ...
    <title>বিস্তারিত উপজেলা বিতরণ রিপোর্ট</title>
...
<body>
    <div class="header">
        <h1>বিস্তারিত উপজেলা বিতরণ রিপোর্ট</h1>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 15%;">জেলা</th>
                <th style="width: 15%;">উপজেলা</th>
                <th style="width: 15%;">ত্রাণের ধরন</th>
                <th style="width: 12%;">মোট পরিমাণ</th>
                <th style="width: 13%;">আবেদনের সংখ্যা</th>
            </tr>
        </thead>
        <tbody>
    ...
    @else
    <div class="no-data">
        <h3>কোনো উপজেলা বিতরণ তথ্য পাওয়া যায়নি</h3>
        <p>বর্তমান ফিল্টার অনুযায়ী কোনো উপজেলা বিতরণ তথ্য খুঁজে পাওয়া যায়নি।</p>
    </div>
    @endif

...
<head>
    ...
    <title>বিস্তারিত প্রকল্প বরাদ্দ রিপোর্ট</title>
...
<body>
    <div class="header">
        <h1>বিস্তারিত প্রকল্প বরাদ্দ রিপোর্ট</h1>
    ...
    <div class="summary">
        ...
        <div class="summary-grid">
            <div class="summary-item">
                <div class="label">মোট প্রকল্প</div>
            ...
            <div class="summary-item">
                ...
                <div class="value">{{ bn_number($data['data']->sum('total_applications')) }}</div>
            </div>
        </div>
    </div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 25%;">প্রকল্পের নাম</th>
                <th style="width: 12%;">ত্রাণের ধরন</th>
                <th style="width: 10%;">অর্থবছর</th>
                <th style="width: 12%;">বরাদ্দকৃত</th>
                <th style="width: 12%;">বিতরণকৃত</th>
                <th style="width: 12%;">অবশিষ্ট</th>
                <th style="width: 8%;">ব্যবহার (%)</th>
                <th style="width: 5%;">আবেদন</th>
            </tr>
        </thead>
        <tbody>
    ...
    @else
    <div class="no-data">
        <h3>কোনো প্রকল্প বরাদ্দ পাওয়া যায়নি</h3>
        <p>বর্তমান ফিল্টার অনুযায়ী কোনো প্রকল্প বরাদ্দ খুঁজে পাওয়া যায়নি।</p>
    </div>
    @endif
